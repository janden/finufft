...
# numpy.distutils has a bug that changes the logging level from under us. Save
# it and reset it later. This only happens on older versions of NumPy, so
# let's check the version before doing this.
